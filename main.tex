...
\dfn{Auxiliary Equations}{
  ...
  If the auxiliary equation has two distinct roots $r_1$ and $r_2$, then the general solution is
  $$y=c_1 e^{r_1 x}+c_2 e^{r_2 x}$$
  If the auxiliary equation has two equal roots, then the general solution is
